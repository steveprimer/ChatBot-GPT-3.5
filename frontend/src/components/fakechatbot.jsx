...
return (
  ...
  setIsOpen(!isOpen);
  setShowPopup(false);
  if (!isOpen) setShowWelcome(true); // Reset welcome screen on open
}} style={{
  ...
  <div style={{
    ...
    <h3 style={{ margin: 0, fontSize: "18px", color: "#fff" }}>How can we help you today?</h3>
    <p style={{ fontSize: "14px", color: "#ccc" }}>Let us know if you have any questions.</p>
    <button
...
<p style={{
  ...
  Powered by <a href="https://scalebridge.netlify.app" target="_blank" rel="noopener noreferrer" style={{ textDecoration:"none", color: "#6884ffff" }}>ScaleBridge</a>
</p>
</div>
</>
);
